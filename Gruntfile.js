...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    // RequireJS optimizer
    // Create two files - cosmattspr.js and cosmattspr-editor.js
    requirejs: {
      engine: {
        options: {
          baseUrl: engine_src,
          name: "cosmattspr",
          out: dist + "cosmattspr.js",
          paths: {
          ...
          exclude: ['normalize'],
            ...
            console.log('Completed requirejs optimization for cosmattspr renderer successfully.');
            done();
          }
        }
      }
      ...
      //   options: {
      //     baseUrl: engine_src,
      //     name: "cosmattspr-editor",
      //     out: dist + "cosmattspr-editor.js",
      //     paths: {
      //       'jquery': 'empty:',
      //       'text': bower_components + 'text/text',
      //       'css': bower_components + 'require-css/css',
      ...
      //     exclude: ['normalize'],
      //     done: function(done, output) {
      //       console.log('Completed requirejs optimization for cosmattspr editor successfully.');
      //       done();
      //     }
      //   }
      // }
